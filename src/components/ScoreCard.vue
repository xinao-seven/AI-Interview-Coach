...
<template>
    <div class="score-card">
        ...
        <div class="score-main">
            ...
            <el-tag size="small" :color="scoreColor(evaluation.totalScore)" effect="dark"
        ...
        <div class="score-details">
            <div class="detail-item">
                ...
                <el-progress :percentage="evaluation.accuracy" :stroke-width="6"
                    :color="scoreColor(evaluation.accuracy)" />
            </div>
            <div class="detail-item">
                <span class="detail-label">完整性</span>
                <el-progress :percentage="evaluation.completeness" :stroke-width="6"
                    :color="scoreColor(evaluation.completeness)" />
            </div>
            <div class="detail-item">
                <span class="detail-label">表达能力</span>
                <el-progress :percentage="evaluation.expression" :stroke-width="6"
                    :color="scoreColor(evaluation.expression)" />
            </div>
            <div class="detail-item">
                <span class="detail-label">项目结合</span>
                <el-progress :percentage="evaluation.projectRelevance" :stroke-width="6"
                    :color="scoreColor(evaluation.projectRelevance)" />
            </div>
            <div class="detail-item">
                <span class="detail-label">回答深度</span>
                <el-progress :percentage="evaluation.depth" :stroke-width="6" :color="scoreColor(evaluation.depth)" />
            </div>
        </div>
